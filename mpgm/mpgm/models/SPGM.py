...
class SPGM(Model):
    ...
    # The return statements save a lot of time (e.g: not having to re-calculate the partition.)
    def calculate_ll_datapoint(self, node:int, datapoint:np.array, node_theta_curr:np.ndarray) -> float:
