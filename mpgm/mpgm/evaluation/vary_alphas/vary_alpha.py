...
nr_variables = 10
nr_samples = 150
alphas = [0.01, 0.05, 0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4, 12.6]
...
if __name__ == '__main__':
    ...
    # stats_gen.plot_ys_common_xs_ALL("nr_variables=10, nr_samples=150, Gibbs, weight", "alpha", alphas)

    # fit_name = "fit_lattice_vary_alpha_SIPRV_batch_1_sample_0"
    # FPS = FitParamsWrapper.load_fit(fit_name, "fit_models.sqlite")
    # print(FPS.fitter)
